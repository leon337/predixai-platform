...
AUTHORIZED_VISUAL_REGION_SPECS = (
    ...
    VisualRegionSpecification("PAYOUT", "Asset payout percentage", ("STATIC_POSITION", "DYNAMIC_CONTENT", "ASSET_DEPENDENT"), "BROKER_ASSET_CARD_PAYOUT", "OCR", "PERCENTAGE", "EXACTLY_ONE_PERCENTAGE_RANGE_0_100", "ALWAYS"),
